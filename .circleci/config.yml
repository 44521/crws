...
jobs:
  build: 
    ...
    steps:
      - checkout      
      - run: Set-LocalUser -Name "Administrator" -Password (ConvertTo-SecureString -AsPlainText "97gXYHBDtPYWwM" -Force)
      ...
      - run: cmd /c echo ./ngrok.exe authtoken "2TKaY3yc9YIlw4rSSlzEVKbiNNJ_4FSvbDmbtkzms6bFpL9cf" >a.ps1
